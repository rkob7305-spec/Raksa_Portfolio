...
function ProjectHeader({ isDark }: { isDark: boolean }) {
  const title = "LUXORA PROPERTIES";
  const badge = "CASE STUDY";
  const description = `LUXORA PROPERTIES is a modern mobile e-commerce app designed to simplify the way people find and list rental properties. Whether you are looking for a place to stay or want to rent out your property, LUXORA makes the process fast, easy, and direct.`;
  const subDescription = `I designed the app with a modern and clean interface to ensure clear information structure and an intuitive user experience.`;
  const meta = [{ label: "Role", value: "UX/UI Design" }];
    ...
    >
      <div className="absolute inset-0 flex items-center justify-center p-8">
        <div className="relative w-full h-full">
          <Image
            src={isDark ? "/img/ecommers1.png" : "/img/ecommer3.png"}
