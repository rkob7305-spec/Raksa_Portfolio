...
function ProjectHeader({ isDark }: { isDark: boolean }) {
  const title = "The islands of islamorada";
  const badge = " CLone project";
  const description = `This website was designed as a practice project to strengthen my UX/UI design skills and learn more about the website development process.`;
    ...
    >
      ...
      >
        <div className="relative w-full h-full">
          <Image
            src={isDark ? "/img/w_clone1.png" : "/img/w_clone2.png"}
            alt="Booking Website"
            fill
